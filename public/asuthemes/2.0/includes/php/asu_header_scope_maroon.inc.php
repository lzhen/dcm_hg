 <!-- START GOLD HEADER-->
   <div id="asu_gold_hdr">
	<?php include('/afs/asu.edu/www/asuthemes/2.0/includes/php/asu_logo_maroon.php'); ?>
	...
	<?php include('/afs/asu.edu/www/asuthemes/2.0/includes/html/asu_universal_nav.shtml'); ?>
      ...
      <div id="asu_login_search">
  	 <?php include('/afs/asu.edu/www/asuthemes/2.0/includes/php/asu_search_scope_maroon.php'); ?>
