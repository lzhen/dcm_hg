          <!-- START SEARCH MODULE /asuthemes/2.0/includes/php/asu_search_scope_maroon.php -->
          <div id="asu_search_module">
              ...
              <form action="http://search.asu.edu/search" method="get" name="gs">
                ...
                <fieldset class="search_range">
                  ...
                  <label for="range_a"><input type="radio" name="site" id="range_a" value="library_collection" checked="checked" />Subsite</label>
                  <label for="range_b"><input type="radio" name="site" id="range_b" value="default_collection" />ASU</label>
                </fieldset>
                <input type="image" name="op" src="<?=$httpProtocol?>://www.asu.edu/asuthemes/2.0/images/asu_magglass_marnbg.gif" value="Search" alt="Search" title="search" class="asu_search_button" />
