 <!-- START GOLD HEADER-->
   <div id="asu_gold_hdr">
	<?php include('/afs/asu.edu/www/asuthemes/2.0/custom/lib/includes/php/lib_logo.php'); ?>
	...
	<?php include('/afs/asu.edu/www/asuthemes/2.0/includes/html/asu_universal_nav.shtml'); ?>
      ...
      <div id="asu_login_search">
  	 ...
  	 <?php include('/afs/asu.edu/www/asuthemes/2.0/custom/lib/includes/php/lib_search_scope.php'); ?>
      </div>
